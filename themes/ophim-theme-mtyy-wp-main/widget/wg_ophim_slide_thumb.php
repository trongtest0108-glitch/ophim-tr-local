<?php
class WG_oPhim_SlideThumb extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'wg_slidethumb', // Base ID
            __( 'Ophim Slide Thumb', 'ophim' ), // Name
    ...
    public function widget( $args, $instance ) {
        ...
        <?php if ($query->have_posts()) :
            include THEME_URL.'/templates/slide/home_page_slider_thumb.php';
        endif; ?>
...
function register_new_widget_SlideThumb() {
    register_widget( 'WG_oPhim_SlideThumb' );
}
add_action( 'widgets_init', 'register_new_widget_SlideThumb' );
