        ...
        switch ($tab) :
                            ...
                            <div>
                                ...
                                <p>
                                    Cấu hình crontab: <code><i style="color:blueviolet">*/10 * * * *</i> cd <i
                                                style="color:blueviolet">/path/to/</i>wp-content/plugins/ophim-core/ &&
                                        php -q schedule.php <i style="color:blueviolet">{secret_key}</i></code>
                                </p>
                                <p>
                                    Ví dụ:
                                    <br/>
                    ...
                    <div class="postbox">
                        <div class="inside">
                            ...
                            <div>
                                ...
                                <p>Bỏ qua năm: <code
                                            style="color: red"><?php echo join(', ', $crawl_ophim_settings->filterYear ?? []); ?></code>
                                </p>
                            </div>
                            <div>
                                <p>Page đầu: <code
            ...
            case 'about':
                ...
                <div class="crawl_page">
                    <div class="postbox">
                        <div class="inside">
                            Ophim1.CC là website dữ liệu phim miễn phí vĩnh viễn. Cập nhật nhanh, chất lượng cao, ổn
                            định và lâu dài. Tốc độ phát cực nhanh với đường truyền băng thông cao, đảm bảo đáp ứng được
                            ...
                            - API được cung cấp miễn phí: <a href="https://ophim1.cc/api-document" target="_blank">https://ophim1.cc/api-document</a>
                            <br/>
                ...
                <div class="crawl_main">
                    <div class="crawl_filter notice notice-info">
                        ...
                        <div class="filter_item">
                            ...
                            <label><input type="checkbox" class="" name="filter_type[]" value="hoathinh"> Hoạt
                                hình</label>
                            <label><input type="checkbox" class="" name="filter_type[]" value="tvshows"> Tv
                                shows</label>
                        </div>
                        ...
                        <div class="filter_item">
                            ...
                            foreach ($categoryFromApi as $category) {
                                ?>
                                <label><input type="checkbox" class="" name="filter_category[]"
                                              value="<?php echo $category->name; ?>"> <?php echo $category->name; ?>
                                </label>
                                <?php
                            }
                            ?>
                        ...
                        <div class="filter_item">
                            ...
                            foreach ($countryFromApi as $country) {
                                ?>
                                <label><input type="checkbox" class="" name="filter_country[]"
                                              value="<?php echo $country->name; ?>"> <?php echo $country->name; ?>
                                </label>
                                <?php
                            }
                            ?>
                        </div>
                        <div class="filter_title"><strong>Bỏ qua năm</strong></div>
                        <div class="filter_item">
                            <?php
                            $filter_year_saved = array_map('strval', $crawl_ophim_settings->filterYear ?? []);
                            $current_year = (int)date('Y');
                            for ($year = $current_year; $year >= $current_year - 49; $year--) {
                                ?>
                                <label style="margin-right: 10px;">
                                    <input type="checkbox" class="" name="filter_year[]" value="<?php echo $year; ?>"
                                        <?php echo in_array((string)$year, $filter_year_saved, true) ? 'checked' : ''; ?>>
                                    <?php echo $year; ?>
                                </label>
                                <?php
                            }
                    ...
                    <div class="crawl_page">
                        <div id="crawl_stats" class="notice notice-info" style="display:none;">
                            <p id="crawl_stats_text">Thống kê crawl sẽ hiển thị tại đây.</p>
                        </div>
