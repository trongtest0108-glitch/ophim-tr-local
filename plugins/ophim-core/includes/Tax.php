...
function ophim_include_myuploadscript()
{
    ...
    $script_version = file_exists(OFIM_PLUGIN_PATCH . 'public/js/script.js') ? filemtime(OFIM_PLUGIN_PATCH . 'public/js/script.js') : '1.0.0';
    wp_enqueue_script('admin_js', OFIM_JS_URL . '/script.js', array('jquery'), $script_version, false);
}
