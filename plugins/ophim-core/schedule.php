...
try {
    ...
    $filterYear = oIsset($crawl_ophim_settings, 'filterYear', []);
    ...
    foreach ($listMovies as $key => $data_post) {
        ...
        $result = crawl_ophim_movies_handle($url, $ophim_id, $ophim_update_time, $crawl_ophim_settings->filterType, $crawl_ophim_settings->filterCategory, $crawl_ophim_settings->filterCountry, $filterYear);
